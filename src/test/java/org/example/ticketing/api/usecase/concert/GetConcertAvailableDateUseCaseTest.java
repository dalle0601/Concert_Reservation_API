...
public class GetConcertAvailableDateUseCaseTest {
    ...
    public void setup() {
        ...
        getConcertAvailableDateUseCase = new GetConcertAvailableDateUseCase(concertRepository);
...
//        Long userId = 1L;
//        when(confirmQueueUseCase.execute(any())).thenReturn(new TokenResponseDTO("abcd-efgh-jklm/onWait/5"));
